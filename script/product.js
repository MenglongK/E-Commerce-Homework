...
async function fetchProduct() {
  ...
  data.map((product) => {
    card += `
        <div class="relative m-auto flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md hover:scale-103 duration-500 hover:shadow-blue-400">
  <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
    <img class="object-cover m-auto hover:scale-3d" src=${product.image} alt=${product.title} />
  </a>
  <div class="mt-4 px-5 pb-5">
    <a href="#">
      <h5 class="text-xl tracking-tight text-slate-900 line-clamp-1">${product.title}</h5>
    </a>
